...
namespace CourseWork
{
	public partial class MainForm : Form
	{
		...
		public static int[,,,] array = new int[n * n, n * n, n * n, n * n];
		...
		void Form1_KeyDown(object sender, KeyEventArgs e)
		{
			...
			try
			{
				...
				{
					var text = "";
					pressedButton.Font = new Font("Microsoft Sans Serif", fontSize - 8, FontStyle.Regular);
					for (int i = 0; i < n * n; i++)
					{
						for (int j = 0; j < n * n; j++)
						{
					...
					{
						case (char)Keys.D1:
							if (array[_i, _j, 0, 0] == 1) array[_i, _j, 0, 0] = 0;
							else array[_i, _j, 0, 0] = 1;
							break;
						case (char)Keys.D2:
							if (array[_i, _j, 0, 1] == 2) array[_i, _j, 0, 1] = 0;
							else array[_i, _j, 0, 1] = 2;
							break;
						case (char)Keys.D3:
							if (array[_i, _j, 0, 2] == 3) array[_i, _j, 0, 2] = 0;
							else array[_i, _j, 0, 2] = 3;
							break;
						case (char)Keys.D4:
							if (array[_i, _j, 1, 0] == 4) array[_i, _j, 1, 0] = 0;
							else array[_i, _j, 1, 0] = 4;
							break;
						case (char)Keys.D5:
							if (array[_i, _j, 1, 1] == 5) array[_i, _j, 1, 1] = 0;
							else array[_i, _j, 1, 1] = 5;
							break;
						case (char)Keys.D6:
							if (array[_i, _j, 1, 2] == 6) array[_i, _j, 1, 2] = 0;
							else array[_i, _j, 1, 2] = 6;
							break;
						case (char)Keys.D7:
							if (array[_i, _j, 2, 0] == 7) array[_i, _j, 2, 0] = 0;
							else array[_i, _j, 2, 0] = 7;
							break;
						case (char)Keys.D8:
							if (array[_i, _j, 2, 1] == 8) array[_i, _j, 2, 1] = 0;
							else array[_i, _j, 2, 1] = 8;
							break;
						case (char)Keys.D9:
							if (array[_i, _j, 2, 2] == 9) array[_i, _j, 2, 2] = 0;
							else array[_i, _j, 2, 2] = 9;
							break;
					}
					for (int i = 0; i < n * n; i++)
					{
						for (int j = 0; j < n * n; j++)
						{
							if (array[_i, _j, i, j] == 0) text += "\t";
							else text += array[_i, _j, i, j].ToString() + "\t ";
						}
						text += "\n";
					}
					pressedButton.Text = text.ToString();
					Console.WriteLine(text.ToString());

				}
				else
				{
					pressedButton.Font = new Font("Yu Gothic", fontSize, FontStyle.Bold);
					switch (codeKey)
					{
						case (char)Keys.D1:
							if (notMakeMistake)
		...
		public void Check_Sudoku()
		{
			...
			for (int i = 0; i < n * n; i++)
			{
				for (int j = 0; j < n * n; j++)
				{
					...
					if (btnText != map[i, j].ToString() && !string.IsNullOrEmpty(btnText) && btnText.Length == 1)
					{
